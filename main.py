...
from title import check_modify_config, config_sort, create_country, create_country_table
...
def find_matches(text_content):
    ...
    return matches_usersname, matches_url, matches_shadowsocks, matches_trojan, matches_vmess, matches_vless, matches_reality
...
for channel_user, message in channel_messages_array:
    try:
        ...
        matches_usersname, matches_url, matches_shadowsocks, matches_trojan, matches_vmess, matches_vless, matches_reality = find_matches(text_content)
...
for url in array_url:
    try:
        ...
        if tg_user not in ['proxy', 'img', 'emoji', 'joinchat'] and '+' not in tg_user and '-' not in tg_user:
...
for channel, messages in new_channel_messages:
    ...
    for message in messages:
        try:
            ...
            text_content = tg_message_text(message)
            # Iterate over each message to extract configuration protocol types and subscription links
            matches_username, matches_url, matches_shadowsocks, matches_trojan, matches_vmess, matches_vless, matches_reality = find_matches(text_content)
            total_config = total_config + len(matches_shadowsocks) + len(matches_trojan) + len(matches_vmess) + len(matches_vless) + len(matches_reality)

            # Extend protocol type arrays and subscription link array
            new_array_usernames.update(matches_username)
...
for url_link in subscription_links:
    try:
        ...
        if 'soroushmirzaei' in url_link and 'channels' in url_link:
...
for url_link, content in array_links_content_decoded:
    ...
    content_merged = "\n".join(content)
    match_user, match_url, match_socks, match_trojan, match_vmess, match_vless, match_reality = find_matches(content_merged)

    if len(match_socks) + len(match_trojan) + len(match_vmess) + len(match_vless) + len(match_reality) != 0:
...
for url_link, content in raw_array_links_content_decoded:
    # Merge all subscription links content and find all protocols matches base on protocol pattern
    raw_content_merged = "\n".join(content)
    match_user, match_url, match_socks, match_trojan, match_vmess, match_vless, match_reality = find_matches(raw_content_merged)
...
def modify_config(shadow_array, trojan_array, vmess_array, vless_array, reality_array, check_port_connection = True):
...
raw_matches_shadowsocks, raw_matches_trojan, raw_matches_vmess, raw_matches_vless, raw_matches_reality = remove_duplicate(raw_matches_shadowsocks, raw_matches_trojan, raw_matches_vmess, raw_matches_vless, raw_matches_reality)
channel_matches_shadowsocks, channel_matches_trojan, channel_matches_vmess, channel_matches_vless, channel_matches_reality = remove_duplicate(channel_matches_shadowsocks, channel_matches_trojan, channel_matches_vmess, channel_matches_vless, channel_matches_reality)
...
raw_matches_shadowsocks, raw_matches_trojan, raw_matches_vmess, raw_matches_vless, raw_matches_reality, raw_matches_tls, raw_matches_non_tls, raw_matches_tcp, raw_matches_ws, raw_matches_http, raw_matches_grpc = modify_config(raw_matches_shadowsocks, raw_matches_trojan, raw_matches_vmess, raw_matches_vless, raw_matches_reality, check_port_connection = False)
channel_matches_shadowsocks, channel_matches_trojan, channel_matches_vmess, channel_matches_vless, channel_matches_reality, channel_matches_tls, channel_matches_non_tls, channel_matches_tcp, channel_matches_ws, channel_matches_http, channel_matches_grpc = modify_config(channel_matches_shadowsocks, channel_matches_trojan, channel_matches_vmess, channel_matches_vless, channel_matches_reality, check_port_connection = True)
...
array_shadowsocks_channels, array_trojan_channels, array_vmess_channels, array_vless_channels, array_reality_channels = remove_duplicate(array_shadowsocks_channels, array_trojan_channels, array_vmess_channels, array_vless_channels, array_reality_channels, vmess_decode_dedup = False)
channel_matches_shadowsocks, channel_matches_trojan, channel_matches_vmess, channel_matches_vless, channel_matches_reality = remove_duplicate(channel_matches_shadowsocks, channel_matches_trojan, channel_matches_vmess, channel_matches_vless, channel_matches_reality, vmess_decode_dedup = False)
...
raw_matches_shadowsocks, raw_matches_trojan, raw_matches_vmess, raw_matches_vless, raw_matches_reality = remove_duplicate(raw_matches_shadowsocks, raw_matches_trojan, raw_matches_vmess, raw_matches_vless, raw_matches_reality, vmess_decode_dedup = False)
...
array_list_configurations = [array_shadowsocks, array_trojan, array_vmess, array_vless, array_reality, array_tls, array_non_tls, array_tcp, array_ws, array_http, array_grpc, matches_shadowsocks, matches_trojan, matches_vmess, matches_vless, matches_reality, matches_tls, matches_non_tls, matches_tcp, matches_ws, matches_http, matches_grpc, raw_matches_shadowsocks, raw_matches_trojan, raw_matches_vmess, raw_matches_vless, raw_matches_reality, raw_matches_tls, raw_matches_non_tls, raw_matches_tcp, raw_matches_ws, raw_matches_http, raw_matches_grpc, channel_matches_shadowsocks, channel_matches_trojan, channel_matches_vmess, channel_matches_vless, channel_matches_reality, channel_matches_tls, channel_matches_non_tls, channel_matches_tcp, channel_matches_ws, channel_matches_http, channel_matches_grpc, array_shadowsocks_channels, array_trojan_channels, array_vmess_channels, array_vless_channels, array_reality_channels, array_tls_channels, array_non_tls_channels, array_tcp_channels, array_ws_channels, array_http_channels, array_grpc_channels]
...
array_shadowsocks, array_trojan, array_vmess, array_vless, array_reality, array_tls, array_non_tls, array_tcp, array_ws, array_http, array_grpc, matches_shadowsocks, matches_trojan, matches_vmess, matches_vless, matches_reality, matches_tls, matches_non_tls, matches_tcp, matches_ws, matches_http, matches_grpc, raw_matches_shadowsocks, raw_matches_trojan, raw_matches_vmess, raw_matches_vless, raw_matches_reality, raw_matches_tls, raw_matches_non_tls, raw_matches_tcp, raw_matches_ws, raw_matches_http, raw_matches_grpc, channel_matches_shadowsocks, channel_matches_trojan, channel_matches_vmess, channel_matches_vless, channel_matches_reality, channel_matches_tls, channel_matches_non_tls, channel_matches_tcp, channel_matches_ws, channel_matches_http, channel_matches_grpc, array_shadowsocks_channels, array_trojan_channels, array_vmess_channels, array_vless_channels, array_reality_channels, array_tls_channels, array_non_tls_channels, array_tcp_channels, array_ws_channels, array_http_channels, array_grpc_channels = array_removed_duplicate_list_configurations
...
readme = '''## Protocol Type Subscription Links
