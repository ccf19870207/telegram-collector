    ...
    if protocol_type == 'SHADOWSOCKS':
        for element in array_configuration:
            ...
            for ip_address in ips_list:
                ...
                config["title"] = f"\U0001F512 SS-TCP-NA {continent_emoji} {country_code}-{config['ip']}:{config['port']} \U0001F4E1 PING-{config_ping:06.2f}-MS"
        ...
        for element in array_configuration:
            ...
            for ip_address in ips_list:
                ...
                # Modify configuration title based on server and protocol properties
                config["title"] = f"\U0001F512 TR-{config_type}-{config_secrt} {continent_emoji} {country_code}-{config['ip']}:{config['port']} \U0001F4E1 PING-{config_ping:06.2f}-MS"
        ...
        for element in array_configuration:
            ...
            for ip_address in ips_list:
                ...
                # Modify configuration title based on server and protocol properties
                config["title"] = f"\U0001F512 VM-{config_type}-{config_secrt} {continent_emoji} {country_code}-{config['ip']}:{config['port']} \U0001F4E1 PING-{config_ping:06.2f}-MS"
        ...
        for element in array_configuration:
            ...
            for ip_address in ips_list:
                ...
                # Modify configuration title based on server and protocol properties
                config["title"] = f"\U0001F512 VL-{config_type}-{config_secrt} {continent_emoji} {country_code}-{config['ip']}:{config['port']} \U0001F4E1 PING-{config_ping:06.2f}-MS"
